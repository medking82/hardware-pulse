...
Windows/macOS 及具有 XFixes 的 Linux X11 可请求原生鼠标穿透锁定，从主界面或托盘、菜单栏重新打开即可解锁。X11 锁定时临时移除可交互的窗口边框，解锁后恢复。Linux X11 原生验证及 Windows ARM64 交互验证仍待完成，当前仍为开发版本。尚未实现原生 Wayland 锁定。
