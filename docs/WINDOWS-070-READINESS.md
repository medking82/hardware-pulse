...
| Cards/Desktop layout | All Monitor card groups and individual Desktop metrics support independent visibility/order with persistence and hotplug recovery. Both views reuse Core.ColumnLayout; desktop hardware/quota/FPS share one ordered layout. Headless and native Windows checks cover updates, settings and narrow controls | Final installed-build layout acceptance, compact FPS presentation and locked-height overflow acceptance remain pending |
