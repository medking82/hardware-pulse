...
| Cards/Desktop layout | Basic Monitor cards and Desktop hardware rows reuse Core.ColumnLayout: Auto/1/2/3 columns, safe narrowing, breakpoint hysteresis and retained controls across updates | Visibility/order controls and full metric layout parity; quota/FPS layout and locked-height overflow acceptance remain pending |
