...
$info.WindowStyle=[Diagnostics.ProcessWindowStyle]::Hidden;$info.UseShellExecute=$false;$info.CreateNoWindow=$true;$info.RedirectStandardOutput=$true;$info.RedirectStandardError=$true
