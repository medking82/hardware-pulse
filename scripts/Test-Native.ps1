...
$arguments=@('/nologo','/target:exe',"/out:$app\NativeTests.exe","/reference:$app\HardwarePulse.exe","/reference:$app\Pulse.Core.dll","/reference:$app\Pulse.Adapters.Windows.dll",'/reference:System.Web.Extensions.dll','/reference:System.Core.dll','/reference:System.Windows.Forms.dll','/reference:System.Xaml.dll',"/reference:$framework\WPF\PresentationFramework.dll","/reference:$framework\WPF\PresentationCore.dll","/reference:$framework\WPF\WindowsBase.dll","$root\scripts\NativeTests.cs","$root\scripts\NativeStartupTests.cs","$root\scripts\NativeFpsTests.cs","$root\scripts\NativeQuotaTests.cs","$root\scripts\NativeQuotaRecoveryTests.cs","$root\scripts\QuotaDiagnosticLogTests.cs")
