...
$arguments=@('/nologo','/target:exe',"/out:$output\UpdateCoordinatorTests.exe",'/reference:System.Web.Extensions.dll',"$root\src\Native\Models.cs","$root\src\UpdateCheck.cs","$root\src\Native\UpdateCoordinator.cs","$root\scripts\UpdateCoordinatorTests.cs")
