...
static class DesktopUpdateTests {
    ...
    public static void Run() {
        ...
        try {
            Check(!panel.HomeAction.IsVisible,"Idle Home update action should remain hidden");
            ...
            Check(panel.HomeAction.IsVisible&&panel.HomeAction.IsEnabled&&panel.HomeAction.Content?.ToString()=="Update to 0.7.1","Compact Home action exposes available version");
            ...
            Check(!panel.HomeAction.IsEnabled,"Home action admits duplicate download");
            ...
            Check(panel.HomeAction.Content?.ToString()=="Install and restart","Home action must require explicit installation");
