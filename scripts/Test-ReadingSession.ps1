...
$arguments=@('/nologo','/target:exe',"/out:$output\ReadingSessionTests.exe",'/reference:System.Web.Extensions.dll',"/reference:$output\Pulse.Core.dll","$root\src\Native\Models.cs","$root\src\Native\SensorProfile.cs","$root\scripts\ReadingSessionTests.cs")
