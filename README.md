...
**[Download 0.6.30 EXE](https://github.com/medking82/hardware-pulse/releases/download/v0.6.30/HardwarePulse-Setup.exe)** · [0.6.30 release notes](https://github.com/medking82/hardware-pulse/releases/tag/v0.6.30)
...
Latest: **0.6.30** avoids updating invisible Monitor cards while Settings is open, reducing allocation during Settings refreshes. Returning to Monitor immediately displays current readings. The Windows WPF UI, glass, settings, hardware, FPS and Desktop behavior are retained.
...
Settings in 0.6.30: Settings → AI Quota enables independent Codex,
...
Version 0.6.30 also displays negotiated Network Link Speed for the selected
...
The published version is **0.6.30** with multilingual UI and animated card reordering. Use the download link above for the latest installer.
...
The release asset `HardwarePulse-Setup.exe` (version 0.6.30) bundles the application, pinned LibreHardwareMonitor libraries,
