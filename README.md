...
**[Download 0.6.0 / 下载 0.6.0 EXE](https://github.com/medking82/hardware-pulse/releases/download/v0.6.0/HardwarePulse-Setup.exe)** · [0.6.0 release notes](https://github.com/medking82/hardware-pulse/releases/tag/v0.6.0)
...
Latest: **0.6.0** adds responsive App cards, an editable Desktop layout, synchronized FPS switches, and connection readings. / 加入 App 多列、Desktop 布局编辑、FPS switches 与连接读数。
...
Settings in 0.6.0: Settings → AI Quota enables independent Codex,
...
Version 0.6.0 also displays negotiated Network Link Speed for the selected
...
The published version is **0.6.0** with multilingual UI and animated card reordering. Use the download link above for the latest installer.
...
The release asset `HardwarePulse-Setup.exe` (version 0.6.0) bundles the application, pinned LibreHardwareMonitor libraries,
...
当前 version 为 **0.6.0**，包含 multi-language UI。使用上方 download link 获取最新 installer。
