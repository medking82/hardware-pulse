...
**[Download 0.5.12 / 下载 0.5.12 EXE](https://github.com/medking82/hardware-pulse/releases/download/v0.5.12/HardwarePulse-Setup.exe)** · [0.5.12 release notes](https://github.com/medking82/hardware-pulse/releases/tag/v0.5.12)
...
Latest: **0.5.12** shows only Gemini 5-hour and Weekly quotas for Antigravity, with shorter Desktop labels. / Antigravity 仅显示 Gemini 5-hour 和 Weekly，缩短 Desktop labels。
...
Settings in 0.5.12: Settings → AI Quota enables independent Codex,
...
Version 0.5.12 also displays negotiated Network Link Speed for the selected
...
The published version is **0.5.12** with multilingual UI and animated card reordering. Use the download link above for the latest installer.
...
The release asset `HardwarePulse-Setup.exe` (version 0.5.12) bundles the application, pinned LibreHardwareMonitor libraries,
...
当前 version 为 **0.5.12**，包含 multi-language UI。使用上方 download link 获取最新 installer。
