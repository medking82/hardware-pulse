...
**[Download 0.6.26 EXE](https://github.com/medking82/hardware-pulse/releases/download/v0.6.26/HardwarePulse-Setup.exe)** · [0.6.26 release notes](https://github.com/medking82/hardware-pulse/releases/tag/v0.6.26)
...
Latest: **0.6.26** preserves App icon colors in Desktop mode even when the chosen icon color equals the text color. Always on top and Local Contrast respect the explicit palette choice; fine contrasting outlines preserve visibility without replacing it.
...
Settings in 0.6.26: Settings → AI Quota enables independent Codex,
...
Version 0.6.26 also displays negotiated Network Link Speed for the selected
...
The published version is **0.6.26** with multilingual UI and animated card reordering. Use the download link above for the latest installer.
...
The release asset `HardwarePulse-Setup.exe` (version 0.6.26) bundles the application, pinned LibreHardwareMonitor libraries,
