...
**[Download 0.5.1 / 下载 0.5.1 EXE](https://github.com/medking82/hardware-pulse/releases/download/v0.5.1/HardwarePulse-Setup.exe)** · [0.5.1 release notes](https://github.com/medking82/hardware-pulse/releases/tag/v0.5.1)
...
Latest: **0.5.1** fixes startup registration when scheduled tasks are missing. Install over a failed 0.5.0 installation to repair the Collector startup; preferences are preserved. / 修复 missing task 导致的 startup registration failure，可直接覆盖安装。
...
The published version is **0.5.1** with multilingual UI and animated card reordering. Use the download link above for the latest installer.
...
The release asset `HardwarePulse-Setup.exe` (version 0.5.1) bundles the application, pinned LibreHardwareMonitor libraries,
...
当前 version 为 **0.5.1**，包含 multi-language UI。使用上方 download link 获取最新 installer。
