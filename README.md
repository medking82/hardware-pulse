...
**[Download 0.6.37 EXE](https://github.com/medking82/hardware-pulse/releases/download/v0.6.37/HardwarePulse-Setup.exe)** · [0.6.37 release notes](https://github.com/medking82/hardware-pulse/releases/tag/v0.6.37)
...
Latest: **0.6.37** reduces repeated card layout work, Desktop FPS text rebuilding and sensor-matching allocation. WPF glass appearance, fonts, settings, quota recovery and refresh intervals remain intact. [Performance measurements and limits](docs/PERFORMANCE.md#wpf-refresh-work-reduction-after-0636). The optional experimental Claude Code status-line source requires manual setup, expires stale snapshots and does not renew credentials. [Setup and rollback](docs/CLAUDE-STATUSLINE.md) · [Integration and validation limits](docs/CLAUDE-QUOTA-RECOVERY.md).
...
Settings in 0.6.37: Settings → AI Quota enables independent Codex,
...
Version 0.6.37 also displays negotiated Network Link Speed for the selected
...
The published version is **0.6.37** with multilingual UI and animated card reordering. Use the download link above for the latest installer.
...
The release asset `HardwarePulse-Setup.exe` (version 0.6.37) bundles the application, pinned LibreHardwareMonitor libraries,
