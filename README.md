...
**[Download 0.6.4 / 下载 0.6.4 EXE](https://github.com/medking82/hardware-pulse/releases/download/v0.6.4/HardwarePulse-Setup.exe)** · [0.6.4 release notes](https://github.com/medking82/hardware-pulse/releases/tag/v0.6.4)
...
Latest: **0.6.4** restores the existing App home when its shortcut is launched again, including from Desktop mode. / 再次点击 App shortcut 会唤回现有首页，支持 Desktop mode。
...
Settings in 0.6.4: Settings → AI Quota enables independent Codex,
...
Version 0.6.4 also displays negotiated Network Link Speed for the selected
...
The published version is **0.6.4** with multilingual UI and animated card reordering. Use the download link above for the latest installer.
...
The release asset `HardwarePulse-Setup.exe` (version 0.6.4) bundles the application, pinned LibreHardwareMonitor libraries,
...
当前 version 为 **0.6.4**，包含 multi-language UI。使用上方 download link 获取最新 installer。
