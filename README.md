...
**[Download 0.6.6 / 下载 0.6.6 EXE](https://github.com/medking82/hardware-pulse/releases/download/v0.6.6/HardwarePulse-Setup.exe)** · [0.6.6 release notes](https://github.com/medking82/hardware-pulse/releases/tag/v0.6.6)
...
Latest: **0.6.6** shows LAN and Wi-Fi link speeds independently in App and Desktop, including idle Wi-Fi rate changes and signal strength. / App 与 Desktop 独立显示 LAN、Wi-Fi 连接速率及 Wi-Fi signal，不受 LAN 流量影响。
...
Settings in 0.6.6: Settings → AI Quota enables independent Codex,
...
Version 0.6.6 also displays negotiated Network Link Speed for the selected
...
The published version is **0.6.6** with multilingual UI and animated card reordering. Use the download link above for the latest installer.
...
The release asset `HardwarePulse-Setup.exe` (version 0.6.6) bundles the application, pinned LibreHardwareMonitor libraries,
...
当前 version 为 **0.6.6**，包含 multi-language UI。使用上方 download link 获取最新 installer。
