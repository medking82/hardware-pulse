...
**[Download 0.6.1 / 下载 0.6.1 EXE](https://github.com/medking82/hardware-pulse/releases/download/v0.6.1/HardwarePulse-Setup.exe)** · [0.6.1 release notes](https://github.com/medking82/hardware-pulse/releases/tag/v0.6.1)
...
Latest: **0.6.1** adds home-screen update actions, fixes Desktop text width, and makes the Desktop icon palette switch easier to find. / 加入 Home update actions、修复 Desktop 文字宽度，并提升 icon palette switch 的可发现性。
...
Settings in 0.6.1: Settings → AI Quota enables independent Codex,
...
Version 0.6.1 also displays negotiated Network Link Speed for the selected
...
The published version is **0.6.1** with multilingual UI and animated card reordering. Use the download link above for the latest installer.
...
The release asset `HardwarePulse-Setup.exe` (version 0.6.1) bundles the application, pinned LibreHardwareMonitor libraries,
...
当前 version 为 **0.6.1**，包含 multi-language UI。使用上方 download link 获取最新 installer。
