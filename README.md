...
**[Download 0.5.11 / 下载 0.5.11 EXE](https://github.com/medking82/hardware-pulse/releases/download/v0.5.11/HardwarePulse-Setup.exe)** · [0.5.11 release notes](https://github.com/medking82/hardware-pulse/releases/tag/v0.5.11)
...
Latest: **0.5.11** fixes Antigravity quota discovery and simplifies Codex to its main Weekly quota. / 修复 Antigravity quota 读取，Codex 仅保留主 Weekly。
...
Settings in 0.5.11: Settings → AI Quota enables independent Codex,
...
Version 0.5.11 also displays negotiated Network Link Speed for the selected
...
The published version is **0.5.11** with multilingual UI and animated card reordering. Use the download link above for the latest installer.
...
The release asset `HardwarePulse-Setup.exe` (version 0.5.11) bundles the application, pinned LibreHardwareMonitor libraries,
...
当前 version 为 **0.5.11**，包含 multi-language UI。使用上方 download link 获取最新 installer。
