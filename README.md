...
**[Download 0.6.9 / 下载 0.6.9 EXE](https://github.com/medking82/hardware-pulse/releases/download/v0.6.9/HardwarePulse-Setup.exe)** · [0.6.9 release notes](https://github.com/medking82/hardware-pulse/releases/tag/v0.6.9)
...
Latest: **0.6.9** groups settings by feature and keeps Desktop layout, appearance and readings together. Topmost uses a lighter background with independent opacity. / 设置按功能分组；Desktop 设置集中管理，置顶背景更轻盈，不透明度可单独调整。
...
Settings in 0.6.9: Settings → AI Quota enables independent Codex,
...
Version 0.6.9 also displays negotiated Network Link Speed for the selected
...
The published version is **0.6.9** with multilingual UI and animated card reordering. Use the download link above for the latest installer.
...
The release asset `HardwarePulse-Setup.exe` (version 0.6.9) bundles the application, pinned LibreHardwareMonitor libraries,
...
当前 version 为 **0.6.9**，包含 multi-language UI。使用上方 download link 获取最新 installer。
