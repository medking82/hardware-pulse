...
**[Download 0.5.10 / 下载 0.5.10 EXE](https://github.com/medking82/hardware-pulse/releases/download/v0.5.10/HardwarePulse-Setup.exe)** · [0.5.10 release notes](https://github.com/medking82/hardware-pulse/releases/tag/v0.5.10)
...
Latest: **0.5.10** adds independent AI quota readings with provider SVG icons and negotiated Network Link Speed. / 新增独立 AI quota、SVG icon 和 Network 连接速率。
...
Settings in 0.5.10: Settings → AI Quota enables independent Codex,
...
Version 0.5.10 also displays negotiated Network Link Speed for the selected
...
The published version is **0.5.10** with multilingual UI and animated card reordering. Use the download link above for the latest installer.
...
The release asset `HardwarePulse-Setup.exe` (version 0.5.10) bundles the application, pinned LibreHardwareMonitor libraries,
...
当前 version 为 **0.5.10**，包含 multi-language UI。使用上方 download link 获取最新 installer。
