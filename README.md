...
**[Download 0.6.11 / 下载 0.6.11 EXE](https://github.com/medking82/hardware-pulse/releases/download/v0.6.11/HardwarePulse-Setup.exe)** · [0.6.11 release notes](https://github.com/medking82/hardware-pulse/releases/tag/v0.6.11)
...
Latest: **0.6.11** shows Current / Average / Minimum FPS on Desktop. Without fresh frames, readings show only — instead of wrapping collector status. / Desktop FPS 显示当前、平均和最低，没有 frame 时只显示 —，不再因状态文字换行。
...
Settings in 0.6.11: Settings → AI Quota enables independent Codex,
...
Version 0.6.11 also displays negotiated Network Link Speed for the selected
...
The published version is **0.6.11** with multilingual UI and animated card reordering. Use the download link above for the latest installer.
...
The release asset `HardwarePulse-Setup.exe` (version 0.6.11) bundles the application, pinned LibreHardwareMonitor libraries,
...
当前 version 为 **0.6.11**，包含 multi-language UI。使用上方 download link 获取最新 installer。
