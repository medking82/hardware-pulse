...
**[Download 0.6.25 EXE](https://github.com/medking82/hardware-pulse/releases/download/v0.6.25/HardwarePulse-Setup.exe)** · [0.6.25 release notes](https://github.com/medking82/hardware-pulse/releases/tag/v0.6.25)
...
Latest: **0.6.25** preserves App icon colors in Desktop mode with Always on top and Local Contrast. Fine contrasting outlines keep palette icons recognizable without replacing their colors; adaptive text and optional monochrome icons remain available.
...
Settings in 0.6.25: Settings → AI Quota enables independent Codex,
...
Version 0.6.25 also displays negotiated Network Link Speed for the selected
...
The published version is **0.6.25** with multilingual UI and animated card reordering. Use the download link above for the latest installer.
...
The release asset `HardwarePulse-Setup.exe` (version 0.6.25) bundles the application, pinned LibreHardwareMonitor libraries,
